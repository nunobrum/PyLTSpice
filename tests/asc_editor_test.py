...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.edt = PyLTSpice.editor.asc_editor.AscEditor("DC sweep.asc")
    ...
    def test_component_editing(self):
        ...
        self.edt.write_netlist('test_components_output.asc')
    ...
    def test_parameter_edit(self):
        ...
        self.edt.write_netlist('test_parameter_output.asc')
    ...
    def test_instructions(self):
        ...
        self.edt.write_netlist('test_instructions_output.asc')
